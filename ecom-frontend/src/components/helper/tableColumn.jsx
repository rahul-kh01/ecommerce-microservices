    ...
    renderCell: (params) => {
      ...
      switch(status?.toLowerCase()) {
        ...
        case "processing":
          ...
          break;
        case "pending":
          badgeClass = "bg-gradient-to-r from-gray-500 to-slate-600 text-white";
          break;
        case "accepted":
          badgeClass = "bg-gradient-to-r from-indigo-500 to-purple-600 text-white";
          break;
        case "cancelled":
          badgeClass = "bg-gradient-to-r from-red-500 to-pink-600 text-white";
          break;
        default:
      ...
      return (
        <div className="flex justify-center">
          <span className={`px-4 py-2 rounded-full text-sm font-semibold shadow-md ${badgeClass}`}>
            {status}
          </span>
        </div>
      );
    ...
    renderCell: (params) => {
      return (
        <div className='flex justify-center items-center space-x-2 h-full pt-2'>
          <button
            onClick={() => handleEdit(params.row)}
            className='flex items-center bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white px-5 py-2 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 font-semibold'>
              <FaEdit className='mr-2'/>
              Edit
          </button>
        </div>
